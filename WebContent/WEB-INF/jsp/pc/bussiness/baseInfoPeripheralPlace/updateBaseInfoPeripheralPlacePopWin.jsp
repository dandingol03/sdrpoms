...
<body>
    <script type="text/javascript">
	    	function updateBaseInfoPeripheralPlace(){
	    		
	    		var r = $('#baseInfoPeripheralPlaceUpdateForm').form('validate');
	    		if(!r) {
	    			return false;
	    		}
	    		...
	    		showWaitingWindow();
	    		$('#baseInfoPeripheralPlaceUpdateForm').form('submit',{
	    			url : 'file/fileUpLoad',
	    			...
	    			success : function(data) {
	    				if (typeof (data) != 'undefined') {
	    					...
	    					if (data != "-1" && data != "") {
	    						var ps = "?photos="+data;
	    						console.log('===data==>', ps);
	    						var addNumber=$("#baseInfoPeripheralPlaceUpdateForm").serializeArray();
	    						addNumber.splice(1,1);
	    						$.post("baseInfo/updateBaseInfoPeripheralPlace"+ps,addNumber,function(data){
	    							$.messager.alert('提示',data.mes,'info');
	    							closeWindow();
	    						...
	    						var addNumber=$("#baseInfoPeripheralPlaceUpdateForm").serializeArray();
	    						$.post("baseInfo/updateBaseInfoPeripheralPlace",addNumber,function(data){
	    							$.messager.alert('提示',data.mes,'info');
	    							closeWindow();
	    							$('#baseInfoPeripheralPlaceTable').datagrid('reload');
	    						}); 
	...
	<form id="baseInfoPeripheralPlaceUpdateForm" enctype="multipart/form-data" method="post" class="operationPage">
		...
		<table>
			...
			<tr>
				<td colspan="4" align="center">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a onclick="updateBaseInfoPeripheralPlace();" class="easyui-linkbutton" iconCls="icon-save">保存</a>
				</td>
			</tr>
		</table>
	</form>
