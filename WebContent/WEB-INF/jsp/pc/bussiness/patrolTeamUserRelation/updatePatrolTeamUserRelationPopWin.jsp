...
<body>
    ...
    jQuery(function($){
		...
		function updatePartolTeamUserRelation(){
			var r = $('#partolTeamUserRelationUpdateForm').form('validate');
			if(!r) {
				return false;
			}
			//更新巡防人基本信息
			$.post("baseInfo/updatePartrolTeamUserRelation", $("#partolTeamUserRelationUpdateForm").serializeArray(),function(data){
				closeSecondWindow();
	...
	<form id="partolTeamUserRelationUpdateForm" method="post" class="operationPage">
		...
		<table>
			<tr>
				...
				<td width="35%" align="left">
					...
					data-options="required:true" disabled="disabled" style="height:20px;font-size:12px;width:90%;" onblur="chkExist()">
					<a style="color:red">*</a>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="4" align="center">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a onclick="updatePartolTeamUserRelation();" class="easyui-linkbutton" iconCls="icon-save">保存</a>
				</td>
			</tr>
		</table>
	</form>
