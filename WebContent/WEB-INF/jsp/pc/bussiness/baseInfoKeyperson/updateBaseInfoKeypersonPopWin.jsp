...
<body>
    <script type="text/javascript">
		...
		function updateBaseInfoKeyperson(){
			var r = $('#baseInfoKeypersonUpdateForm').form('validate');
			if(!r) {
				return false;
			}
			$.post("baseInfo/checkPersonOrgId", $("#baseInfoKeypersonUpdateForm").serializeArray(),function(data){
    			if(data.mes!=""){
    				$.messager.alert('提示',data.mes,'info');
    			}else{
    				showWaitingWindow();
    	    		$('#baseInfoKeypersonUpdateForm').form('submit',{
    	    			url : 'file/fileUpLoad',
    	    			...
    	    			success : function(data) {
    	    				if (typeof (data) != 'undefined') {
    	    					...
    	    					if (data != "-1" && data != "") {
    	    						var ps = "?photos="+data;
    	    						console.log('===data==>', ps);
    	    						var addNumber=$("#baseInfoKeypersonUpdateForm").serializeArray();
    	    						addNumber.splice(1,1);
    	    						$.post("baseInfo/updateBaseInfoKeyperson"+ps,addNumber,function(data){
    	    							$.messager.alert('提示',data.mes,'info');
    	    							closeWindow();
    	    						...
    	    						var addNumber=$("#baseInfoKeypersonUpdateForm").serializeArray();
    	    						$.post("baseInfo/updateBaseInfoKeyperson",addNumber,function(data){
    	    							$.messager.alert('提示',data.mes,'info');
    	    							closeWindow();
    	    							$('#baseInfoKeypersonTable').datagrid('reload');
    	    						}); 
	...
	<form id="baseInfoKeypersonUpdateForm" enctype="multipart/form-data" method="post" class="operationPage">
		...
		<table>
			<tr>
				...
				<td width="35%" align="left">
					<input name="idNumber" class="easyui-validatebox textbox" data-options="required:true" style="height:20px;font-size:12px;width:90%;" validType="idCode">
					<a style="color:red">*</a>
				</td>
			...
			<tr>
				...
				<td width="35%" align="left">
					<input  name="age" class="easyui-validatebox textbox" data-options="required:true" style="height:20px;font-size:12px;width:90%;" validType="integer">
					<a style="color:red">*</a>
				</td>
			</tr>
			<tr>
				...
				<td width="35%" align="left">
					<input  name="height" class="easyui-validatebox textbox" style="height:20px;font-size:12px;width:90%;" validType="integer">
					
				</td>
			
				<td width="15%" align="right">体重(kg)：</td>
				<td width="35%" align="left">
					<input class="easyui-validatebox textbox" name="weight" style="height:20px;font-size:12px;width:90%;" validType="integer">
				</td>
			</tr>
		<tr>
			...
			<tr>
				...
				<td width="35%" align="left">
					<input  name="lng" class="easyui-validatebox textbox"  style="height:20px;font-size:12px;width:90%;" validType="number">
				</td>
				<td width="15%" align="right">纬度：</td>
				<td width="35%" align="left">
					<input  name="lat" class="easyui-validatebox textbox"  style="height:20px;font-size:12px;width:90%;" validType="number">
				</td>
			</tr>
			<tr>
				...
				<td width="20%" align="right">重点人照片：</td>
				<td width="30%" align="left">
					<input name="uploadFile" id="photosName" value="${photosName}" class="easyui-filebox" data-options="accept:'image/jpeg,image/gif,image/jpg,image/png',prompt:'请选择记录文件...',buttonText:'请选择文件',multiple:true"  style="height:20px;font-size:12px;width:90%;">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="4" align="center">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a onclick="updateBaseInfoKeyperson();" class="easyui-linkbutton" iconCls="icon-save">保存</a>
				</td>
			</tr>
		</table>
	</form>
