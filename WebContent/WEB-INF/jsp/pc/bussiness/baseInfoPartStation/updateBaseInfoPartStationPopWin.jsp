...
<body>
    <script type="text/javascript">
		function updateBaseInfoPartStation(){
			var r = $('#baseInfoPartStationUpdateForm').form('validate');
			if(!r) {
				return false;
			}
			...
			showWaitingWindow();
    		$('#baseInfoPartStationUpdateForm').form('submit',{
    			url : 'file/fileUpLoad',
    			...
    			success : function(data) {
    				if (typeof (data) != 'undefined') {
    					...
    					if (data != "-1" && data != "") {
    						var ps = "?fileId="+data;
    						console.log('===data==>', ps);
    						var addNumber=$("#baseInfoPartStationUpdateForm").serializeArray();
    						addNumber.splice(1,1);
    						$.post("baseInfo/updateBaseInfoPartStation"+ps,addNumber,function(data){
    							$.messager.alert('提示',data.mes,'info');
    							closeWindow();
    						...
    						var addNumber=$("#baseInfoPartStationUpdateForm").serializeArray();
    						$.post("baseInfo/updateBaseInfoPartStation",addNumber,function(data){
    							$.messager.alert('提示',data.mes,'info');
    							closeWindow();
    							$('#baseInfoPartStationTable').datagrid('reload');
    						}); 
    ...
    <!--弹出的更新框结构 -->
	<form id="baseInfoPartStationUpdateForm" enctype="multipart/form-data" method="post" class="operationPage">
		...
		<table>
			...
			<tr>
				<td colspan="4" align="center">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a onclick="updateBaseInfoPartStation();" class="easyui-linkbutton" iconCls="icon-save">保存</a>
				</td>
			</tr>
		</table>
	</form>
