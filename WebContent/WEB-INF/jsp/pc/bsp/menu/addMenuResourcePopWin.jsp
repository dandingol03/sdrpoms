...
<body>
	...
	function addMenuResourceRelation(){
		var r = $('#addMenuResourceRelationForm').form('validate');
		if(!r) {
			return false;
		}
		$.post("menu/addMenuResourceRelate",$("#addMenuResourceRelationForm").serializeArray(),function(data){
	...
	<form id="addMenuResourceRelationForm" method="post" class="operationPage">
		<table>
			<tr>
			...
			<tr>
				<td colspan="2" align="center">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a onclick="addMenuResourceRelation();" class="easyui-linkbutton" iconCls="icon-save" >保存</a>
				</td>
			</tr>
		</table>
	</form>
