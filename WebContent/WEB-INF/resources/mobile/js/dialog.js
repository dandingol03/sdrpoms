    ...
    $.extend({
        ...
        confirm: function(opts = {}) {
            ...
            <div class="modal dialog-modal action-dialog">
                <div class="action-item">
                    <span ><p>${opts.label ? opts.label : '提示'}</p></span>
                </div>
                <div style="height:1px; background:RGBA(243, 243, 243, 1.00); width:100%;"></div>
        ...
        showLoading: function(title = '加载中...') {
            ...
            var d = `
              <div class="loading" style="z-index:11600;">
                  <span><img src="resources/mobile/images/loading.gif"><i class="fa fa-circle-o-notch spin-icon-loading spin-icon" style="font-size: 18px;"></i></span>
