...
<body>
    ...
    var rmSetting = {
  	...
  	//保存[资源-菜单]对应关系
  	function addResReg(){
  		var sNode = rmTree.getSelectedNodes()[0];
  		//更新
	...
	<form id="regResForm" method="post" class="operationPage" style="margin-top:0;padding-top:0;">
		<table style="border-collapse:collapse;">
			<tr style="display:none;">
				<td style="width:50%"><input id="resourceId" name="resourceId" type="hidden"></td>
			</tr>
			<tr>
				<td valign="top" style="margin-top:0;padding-top:0;"><ul id="resMenuTree" class="ztree"></ul></td>
			<tr>
			<tr>
				<td>
					<a onclick="closeWindow();" class="easyui-linkbutton" iconCls="icon-cancel">返回</a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a onclick="addResReg();" class="easyui-linkbutton" iconCls="icon-save">保存</a>
				</td>
			</tr>
		</table>
	</form>
