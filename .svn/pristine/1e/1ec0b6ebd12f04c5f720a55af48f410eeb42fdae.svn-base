...
<body>
    ...
    jQuery(function($){
		...
		function updatePatrolManagementTask(){
			var r = $('#patrolManagementTaskUpdateForm').form('validate');
			if(!r) {
				return false;
			}
			//更新监控基本信息
			$.post("baseInfo/updatePatrolManagementTask", $("#patrolManagementTaskUpdateForm").serializeArray(),function(data){
				closeWindow();
	...
	<form id="patrolManagementTaskUpdateForm" method="post" class="operationPage">
		...
		<table>
			...
			<tr>
				...
				<td width="35%" align="left">
					<input name="telephone" class="easyui-validatebox textbox"data-options="required:true,validType:['mobileAndTel','mobile']" data-options="required:true" style="height:20px;font-size:12px;width:90%;">
				</td>
				<td width="15%" align="right">所属机构：</td>
				<td width="35%" align="left">
					<input id="orgIdD" type="text" name="orgId" class="easyui-textbox " 
			...
			<tr>
				<td colspan="4" align="center">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a onclick="updatePatrolManagementTask();" class="easyui-linkbutton" iconCls="icon-save">保存</a>
				</td>
			</tr>
		</table>
	</form>
