 ...
 * Dao
 */
@Repository("mobileOaInfoDocumentDao")
public class MobileOaInfoDocumentDao{
	...
	public Integer anUnreadMailCount(
	    ...
	    String Sql = "select count(1) from oa_document t where 1=1"
	    	+ "  and is_delete= 0 "
	    	+ "  and is_approved= 1 "
	    	+ "and is_drafts =1 "
	    	+ "and send_user_id='"+oaInfoDocumentPo.getSendUserId()+"'";
