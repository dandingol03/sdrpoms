...
<body>
	...
	function addMenuResourceRelation(){
		var r = $('#updateMenuResourceRelationForm').form('validate');
		if(!r) {
			return false;
		}
		$.post("menu/updateMenuResourceRelate",
				$("#updateMenuResourceRelationForm").serializeArray(),
				function(data){
	...
	<form id="updateMenuResourceRelationForm" method="post" class="operationPage">
		<table>
			<tr>
