...
<body>
    <script type="text/javascript">
		...
		function updateVideoMonitorInfo(){
			var r = $('#videoMonitorInfoUpdateForm').form('validate');
			if(!r) {
				return false;
			}
			...
			//更新监控基本信息
			$.post("baseInfo/updateVideoMonitorInfo", $("#videoMonitorInfoUpdateForm").serializeArray(),function(data){
				closeWindow();
	...
	<form id="videoMonitorInfoUpdateForm" method="post" class="operationPage">
		...
		<table>
			...
			<tr>
				...
				<td width="35%" align="left">
					<input id="username" name="username" class="easyui-validatebox textbox" data-options="required:true" style="height:20px;font-size:12px;width:90%;"onblur="chkExist()">
					<a style="color:red">*</a>
				</td>
			...
			<tr>
				<td width="15%" align="right">通道号：</td>
				<td width="35%" align="left">
			...
			<tr>
				<td colspan="4" align="center">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a onclick="updateVideoMonitorInfo();" class="easyui-linkbutton" iconCls="icon-save">保存</a>
				</td>
			</tr>
		</table>
	</form>
