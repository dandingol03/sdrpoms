...
import com.pc.busniess.oaDocument.dao.OaInfoOutBoxDocumentDao;
 ...
 * service
 */
@Service("oaInfoOutBoxDocumentService")
public class OaInfoOutBoxDocumentService {

	@Autowired
	private OaInfoOutBoxDocumentDao oaInfoOutBoxDocumentDao;
	/**
	 * 查询发件箱
	 * @param dgm
