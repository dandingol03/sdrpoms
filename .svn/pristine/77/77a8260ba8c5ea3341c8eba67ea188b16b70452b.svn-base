...
import com.mobile.busniess.mobileOaDocument.dao.MobileOaInfoDraftsDocumentDao;
 ...
 * Service
 */
@Service("mobileOaInfoDraftsDocumentService")
public class MobileOaInfoDraftsDocumentService {

	@Autowired
	private MobileOaInfoDraftsDocumentDao oaInfoDraftsDocumentDao;
